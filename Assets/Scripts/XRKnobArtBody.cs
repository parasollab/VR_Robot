...
namespace Unity.VRTemplate
{
    ...
    /// </summary>
    public class XRKnobArtBody : XRBaseInteractable
    {
        ...
        [SerializeField]
        [Tooltip("The ArticulationBody that is manipulated")]
        ArticulationBody m_ArtBody = null;
        ...
        /// <summary>
        /// The ArticulationBody that is manipulated
        /// </summary>
        ...
        void SetKnobRotation(float angle)
        {
            ...
            if(m_ArtBody != null)
            {
                Debug.Log("Setting joint position");
                ArticulationReducedSpace jointPosition = new ArticulationReducedSpace(angle * Mathf.Deg2Rad);
                m_ArtBody.jointPosition = jointPosition;    
            }
        }
